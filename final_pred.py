...
class Application:
    ...
    def __init__(self):
        ...
        #########################################################
        self.root.title("select a language")
                
        # Add a dropdown (OptionMenu) with options
        self.options = ['hindi', 'english', 'kannada',]
        ...
        self.dropdown.place(x=1305, y=550)  # Position of the dropdown list

        # Create a button that will trigger the speak function
        self.speak = tk.Button(self.root)
        self.speak.place(x=1305, y=630)  # Position of the button
    ...
    def speak_fun(self):
        ...
        # You can replace the print statement with any function you need
        # e.g., using a TTS function or any other action.
        # self.speak_text(selected_value)
        ...
        self.clear.config(text="hindi", font=("Courier", 20), wraplength=100, command=self.clear_fun)
