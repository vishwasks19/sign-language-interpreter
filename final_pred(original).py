...
from speakttsFinal import text_to_speech_in_language
...
class Application:
    ...
    def __init__(self):
        ...
        self.language_label = tk.Label(self.root, text="Select Language:", font=("Courier", 20))
        self.language_label.place(x=1100, y=500)
        ...
        self.language_dropdown.place(x=1100, y=540)
        
        # Bind the language change event
    ...
    def on_language_change(self, event):
        ...
        """
        # Reinitialize TTS with new language settings
        # self.setup_language_tts()
        
        # Optional: You can add more language-specific customizations here
        print(f"Language changed to: {self.language_var.get()}")
    ...
    def speak_fun(self):
        if (self.str.lower()).strip()=="hru":
            text_to_speech_in_language("How are you",self.languages[self.language_var.get()])
        elif (self.str.lower()).strip()=="hw":
            text_to_speech_in_language("hello world",self.languages[self.language_var.get()])
        elif (self.str.lower()).strip()=="h":
            text_to_speech_in_language("Hello",self.languages[self.language_var.get()])
        # elif (self.str.lower()).strip()=="hw":
        #     text_to_speech_in_language("hello world",self.languages[self.language_var.get()])
        
        else:    
            text_to_speech_in_language(self.str,self.languages[self.language_var.get()])
